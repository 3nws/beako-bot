...
class Osu(commands.Cog):
    ...
    async def osu_profile(self, i: discord.Interaction, player_name: str):
        ...
        try:
            ...
            select: Select[View] = Select(
                options=self.osu.game_mode_options,
    ...
    @app_commands.describe(
        player_name="The player you want to get the recent plays of, in fact!"
    )
    ...
    @app_commands.describe(
        player_name="The player you want to get the best plays of, in fact!"
    )
