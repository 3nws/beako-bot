    ...
    async def remind(self, ctx, time, unit=None, *, reminder=""):
        ...
        if seconds == 0:
            ...
            if reminder == "":
                ...
                await ctx.send(
                    f"Hey {ctx.author.mention}, what up, in fact! You asked me to remind you about '{reminder}' {counter} ago, I suppose!"
                )
            return
        ...
        try:
            ...
            if time_left <= 0:
                ...
                if reminder == "":
                    ...
                    await ctx.send(
                        f"Hey {ctx.author.mention}, what up, in fact! This is your Betty alarm for '{reminder}', I suppose!"
                    )
                return
            await ctx.send(embed=embed)
